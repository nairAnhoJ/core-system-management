            ...
            <div class="w-1/3 bg-white rounded-lg">
                ...
                <form wire:submit='destroy' class="relative bg-white rounded-lg shadow">
                    ...
                    <div class="p-4 text-left">
                        ...
                        <h1 class="">Name: <span class="font-medium">{{ $deleteName }}</span></h1>
                        <h1 class="">Address: <span class="font-medium">{{ $deleteAddress }}</span></h1>
                        <h1 class="mb-2">Area: <span class="font-medium">{{ $deleteArea }}</span></h1>
                        <p class="italic">Are you sure you want to delete this Customer?</p>
                    </div>
                    <!-- Modal footer -->
